...
output:
  ...
  word_document:
    fig_caption: true          # 図キャプション作成
lang: ja                       # 言語環境を指定
# フォントを個別に指定することもできるが、zxjafontを使うことにした
# mainfont: IPAPGothic
# monofont: IPAGothic
# mainfont: Meiryo
# monofont: Meiryo UI
...
# knitr::opts_chunk$set(setHook(packageEvent("grDevices", "onLoad"), function(...)grDevices::pdf.options(family="Japan1")))
...
lm_coef <- iris_long %>% 
  ...
  unnest()
```
```{r, echo=FALSE, fig.height=2.2, fig.width=5, fig.cap="線形モデルの結果を確認する"}
